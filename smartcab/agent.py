...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
		...
		# trial numberis initially 0
        self.trial_num = 0
		
		# definition is as following: [waypoint, light, left, right, oncoming]
        self.state_def = [
            ['left', 'right', 'forward'], ['red', 'green'], ['left', 'right', 'forward', None], ['left', 'right', 'forward', None], ['left', 'right', 'forward', None]
        ]
